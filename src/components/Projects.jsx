  ...
  return (
    <>
      <section
        ...
        id="projects"
      >
        {/* Background animation - overflow hidden only on this decorative wrapper */}
      ...
      {selectedProject &&
        createPortal(
          ...
          >
            <div
              className="bg-gray-900 rounded-lg max-w-3xl w-full max-h-[90vh] overflow-y-auto shadow-2xl border border-gray-800"
              style={{ zIndex: 10000 }}
              onClick={(e) => e.stopPropagation()}
            >
              <div
                className="sticky top-0 bg-gray-900 border-b border-gray-800 p-4 flex justify-between items-center"
                style={{ zIndex: 10001 }}
              >
